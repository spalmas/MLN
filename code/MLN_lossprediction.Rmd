...
* All pixels change the same rate. In other words, there are no areas that have higher or lower proportional production.
...
mln_perc_Loss_2013 <- mln_total_Loss_2013/SPAM2013_prod
mln_perc_Loss_2018 <- (mln_total_Loss_oct2017 + mln_total_Loss_march2018)/SPAM2018_prod
...
#The production loss has the units of MT/pixel. We need to convert the units
